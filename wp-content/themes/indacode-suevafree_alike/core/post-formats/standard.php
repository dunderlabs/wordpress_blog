...
<article class="article">
    ...
    <div class="line"> 
        ...
        <div class="entry-info <?php if (suevafree_setting('suevafree_view_comments') == "on" ) echo "viewcomments"; ?>">
            ...
            <span class="entry-comments"><i class="icon-comments-alt" ></i><?php echo comments_number( '<a href="'.get_permalink($post->ID).'#respond">'.__( "Sem comentários","wip").'</a>', '<a href="'.get_permalink($post->ID).'#comments">1 '.__( "comentário","wip").'</a>', '<a href="'.get_permalink($post->ID).'#comments">% '.__( "comentários","wip").'</a>' ); ?></span>
            <?php endif; ?>
            <span class="entry-standard"><i class="icon-edit"></i>Artigo</span>
            <span class="entry-standard"><i class="icon-author"></i><?php the_author(); ?></span>
        </div>
