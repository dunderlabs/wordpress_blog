...
if ( have_comments() ) : 
	...
	echo comments_number( '<h3 class="comments">'.__( "Sem comentários","wip").'</h3>', '<h3 class="comments">1 '.__( "comentário","wip").'</h3>', '<h3 class="comments">% '.__( "comentários","wip").'</h3>' ); 
...
<section class="contact-form">
	...
	<?php comment_form(array('label_submit' =>  __('Comentar','wip')) ); ?>
